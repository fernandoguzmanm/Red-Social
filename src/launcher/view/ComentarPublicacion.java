...
public class ComentarPublicacion extends JDialog {
	...
	public ComentarPublicacion(Controller ctrl, Frame parent, InfoPublicacion p, InfoUsuario viewer) {
...
//			_ctrl.crearComentario(comentario, "publicacion", _publicacion.get_id());
		});
		panel.add(enviar);
